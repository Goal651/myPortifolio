  ...
  return (
    <section id="tech" className="min-h-screen py-20 bg-gray-50 dark:bg-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl font-semibold mb-4">Technical Expertise</h2>
          <p className="text-gray-600 dark:text-gray-300 text-lg">
            A comprehensive overview of the tools, technologies, and frameworks that power my development process.
          </p>
        </motion.div>
